...
const logBefore = helper.logBefore;
...
app.get('/create_user', logBefore, (req, res, next) => validatorParams(req, res, next, createUserController.schema), createUserController.func);
const createGameController = require('./controller/create_game');
app.get('/create_game', logBefore, (req, res, next) => validatorParams(req, res, next, createGameController.schema), createGameController.func);
const gameResultController = require('./controller/game_result')
app.get('/game_result', logBefore, (req, res, next) => validatorParams(req, res, next, gameResultController.schema), gameResultController.func);
app.get('/random_scenario', logBefore, require('./controller/random_scenario'));
const joinGameController = require('./controller/join_game')
app.get('/join_game', logBefore, (req, res, next) => validatorParams(req, res, next, joinGameController.schema), joinGameController.func);
const endGameController = require('./controller/end_game')
app.get('/end_game', logBefore, (req, res, next) => validatorParams(req, res, next, endGameController.schema), endGameController.func);
const startGameController = require('./controller/start_game')
app.get('/start_game', logBefore, (req, res, next) => validatorParams(req, res, next, startGameController.schema), startGameController.func);
const gameStatusController = require('./controller/game_status')
app.get('/game_status', logBefore, (req, res, next) => validatorParams(req, res, next, gameStatusController.schema), gameStatusController.func);
const pingController = require('./controller/ping')
app.get('/ping', logBefore, (req, res, next) => validatorParams(req, res, next, pingController.schema), pingController.func);

const wikiProxyController = require('./controller/wiki_proxy');
app.get('/wiki/:wikiPath', logBefore, wikiProxyController);

const webViewController = require('./controller/web_view');
app.get('/web_view', logBefore, webViewController.index)
app.post('/web_view/login', logBefore, webViewController.login);
app.post('/web_view/start_single_player', logBefore, webViewController.start_single_player);
